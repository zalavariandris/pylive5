from pygraphrt2.graph_rt2 import MissingOperatorError
import pytest
...
class TestUpdatingOperatorFunction:
    def test_update_operator_body(self):
        ...
        G.update_operator(the_node.get_operator(), rt.FunctionOperator(add))
    ...
    def test_execute_raises_type_error_after_operator_update_adds_required_parameter(self):
        ...
        G.update_operator(the_node.get_operator(), rt.FunctionOperator(add_three))
    ...
    def test_set_operator_function_with_same_signature(self):
        ...
        G.update_operator(mult_op, rt.FunctionOperator(divide))
