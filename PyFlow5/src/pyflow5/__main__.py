...
from qtpy.QtWidgets import QHBoxLayout, QLabel, QSplitter, QSplitter, QTextEdit, QWidget, QMainWindow
...
from qdageditor5.models.abstract_dag_model import (
    DirectionalLinkId, InletName, NodeName, OutletName
)
...
class PyFlow5Window(QMainWindow):
    def __init__(self, parent=None):
        ...
        def watch_graph_node(node:NodeRT):
            self._watcher.stop()
